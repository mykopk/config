...
Thank you for considering contributing to **@myko.pk/config** — we appreciate every bug report, documentation fix, feature suggestion, and pull request.
...
2. Clone your fork:
   ```bash
   git clone https://github.com/mykopk/config.git
   ```
...
```
src/
└── db/           # Database-related configuration constants
```
...
- Write tests for every new configuration constant or utility
...
Open an issue at https://github.com/mykopk/config/issues with:
